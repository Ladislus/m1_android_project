...
public class Tables {
    ...
    public static final int PARTICIPATION_CHALLENGE_ID_INDEX = 0;
    public static final String PARTICIPATION_USER_ID = "p_u_id";
    public static final int PARTICIPATION_USER_ID_INDEX = 1;
    public static final String PARTICIPATION_DRAWING_ID = "p_d_id";
    public static final int PARTICIPATION_DRAWING_ID_INDEX = 2;
